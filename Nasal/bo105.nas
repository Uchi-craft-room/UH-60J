...
var fuel = {
	init: func {
		...
		me.capacity = me.main1.capacity + me.main2.capacity + me.supply.capacity + me.ext1.capacity + me.ext2.capacity;
		me.warntime = 0;
		me.update(0);
	},
	update: func(dt) {
		...
		var level = me.main1.level() + me.main2.level() + me.supply.level() + me.ext1.level()+ me.ext2.level();
